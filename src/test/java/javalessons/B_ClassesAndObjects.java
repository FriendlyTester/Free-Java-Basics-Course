...
public class B_ClassesAndObjects
{
    ...
    public void CreateANewObject()
    {
        ...
        //So I want to use the class javalessons.Car in my code here, therefore I need to make an instance of that class.
        //So I have to create an object which will be of the type car, it will be a variable so I give it a name.

        //Here I've declared a variable called myCar which is of the type javalessons.Car. I've then used the new keyword to say I want a new instance of the class javalessons.Car.
        Car myCar = new Car();

        //I now have a new instance of the javalessons.Car class, so I have access to its public variables and methods
        //Here I'm just asking Java to print a line to the console when the program runs
        //The value I'm asking it to print is what the javalessons.Car class returns when I asked for the variable 'name'.
        //So we should see 'Richards javalessons.Car' in the console if we run this test
